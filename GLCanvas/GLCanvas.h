...
public:
	...
	void PaintLine(double x0, double y0, double z0, double x1, double y1, double z1, const Color &color, float thick);
	void PaintLine(const Point3D &p0, const Point3D &p1, const Color &color, float thick);
	void PaintLine(const Segment3D &p, const Color &color, float thick);
	void PaintLines(const Vector<Point3D>& lines, const Color &color);
